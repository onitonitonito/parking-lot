...
### 🚀 v2.0-Transformer-Official (2026-02-08)

> **"RT-DETR 트랜스포머 도입 및 글로벌 UI 최적화"**

- **✨ 주요 변경 사항**
  - **AI 엔진 업그레이드**: YOLOv8n → **RT-DETR-L** (작은 객체 및 고밀도 지역 탐지 성능 극대화)
  - **다국어 지원 (KO/EN)**: UI 실시간 한/영 전환 기능 추가 (기본: 한글)
  - **고해상도 분석**: 추론 해상도 상향 및 앱 기본창 크기 최적화 (**2062x991**)
  - **인터랙티브 기능**: 실시간 혼잡도 **히트맵(Heatmap)** 및 원본-결과 비교 슬라이더 강화

- **🔧 버그 수정 및 개선**
  - 반응형 레이아웃 stretch 오류 수정 및 파비콘 호환성 문제 해결
  - 히스토리 상세 데이터(details) 연동 안정화
